...
namespace DataAcess.Migrations
{
    ...
    [Migration("20250511153612_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.DTOs.Food.RecipeRawDTO", b =>
                {
            ...
            modelBuilder.Entity("Domain.Domain.FavoriteRecipe", b =>
                {
            ...
            modelBuilder.Entity("Domain.Domain.Image", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Domain.Ingredient", b =>
                {
            ...
            modelBuilder.Entity("Domain.Domain.Nutrition", b =>
                {
            ...
            modelBuilder.Entity("Domain.Domain.Recipe", b =>
                {
                    b.Property<int>("Recipe_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Domain.Recipe_Ingredient", b =>
                {
                    b.Property<int>("RecipeId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Domain.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Domain.Domain.FavoriteRecipe", b =>
                {
                    b.HasOne("Domain.Domain.Recipe", "Recipe")
                        .WithMany("FavoritedBy")
                        .HasForeignKey("RecipeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Domain.ApplicationUser", "User")
            ...
            modelBuilder.Entity("Domain.Domain.Nutrition", b =>
                {
                    b.HasOne("Domain.Domain.Recipe", "Recipe")
                        .WithOne("Nutrition")
                        .HasForeignKey("Domain.Domain.Nutrition", "Recipe_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Domain.Recipe_Ingredient", b =>
                {
                    b.HasOne("Domain.Domain.Ingredient", "Ingredient")
            ...
            modelBuilder.Entity("Domain.Domain.ApplicationUser", b =>
                {
                    b.HasOne("Domain.Domain.Image", "Image")
                        .WithMany()
