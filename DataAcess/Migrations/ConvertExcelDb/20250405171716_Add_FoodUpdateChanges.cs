...
{
    /// <inheritdoc />
    public partial class Add_FoodUpdateChanges : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    RecipeId = table.Column<int>(type: "int", nullable: false),
                    Calories100g = table.Column<double>(type: "float", nullable: false),
                    Fat100g = table.Column<double>(type: "float", nullable: false),
                    Sugar100g = table.Column<double>(type: "float", nullable: false),
                    Protein100g = table.Column<double>(type: "float", nullable: false),
                    Carb100 = table.Column<double>(type: "float", nullable: false),
                    Type = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Nutritions", x => x.RecipeId);
                    table.ForeignKey(
